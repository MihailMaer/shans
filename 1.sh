...
EOF
echo "Yes 1.2"
echo "Конфиг создан > /etc/net/ifaces/ens33"
...
echo "172.16.1.1/28" > /etc/net/ifaces/ens35/ipv4address
echo "Yes 1.4"
mkdir -p /etc/net/ifaces/ens36
cat > /etc/net/ifaces/ens36/options << 'EOF'
TYPE=eth
BOOTPROTO=static
CONFIG_IPV4=yes
DISABLED=no
...
echo "172.16.2.1/28" > /etc/net/ifaces/ens36/ipv4address
echo "Yes 1.5"
